...
import { XMarkIcon, MicrophoneIcon, StopIcon, LoaderIcon, SparklesIcon } from './icons';
...
// FIX: Import OrganizedData type
import { VoiceSettings, OrganizedData } from '../types';

interface ProjectPlannerModalProps {
  isOpen: boolean;
  onClose: () => void;
  // FIX: Update onPlanGenerated prop to accept the full plan object
...
const ProjectPlannerModal: React.FC<ProjectPlannerModalProps> = ({ isOpen, onClose, onPlanGenerated, voiceSettings }) => {
    ...
    const handleGeneratePlan = async () => {
        ...
        try {
            ...
            // FIX: Pass the entire plan object to onPlanGenerated
            ...
            case 'initial':
                return (
                    <div className="p-6 text-center">
                        ...
                        <p className="text-slate-600 mb-6">Describe your main goal, and the AI will help you break it down by asking clarifying questions.</p>
                        <textarea
                            value={initialGoal}
                        ...
                        <button
                            ...
                            className="mt-4 w-full px-4 py-3 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 transition-colors"
                        >
                            Start Planning
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="p-4 border-t border-slate-200 flex items-center justify-between gap-4">
                            {stage === 'generating' ? (
                                ...
                                <>
                                    <button
                                        onClick={chatStatus === 'listening' ? stopSession : () => startSession(initialGoal)}
