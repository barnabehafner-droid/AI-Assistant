...
import { TrashIcon, PlusIcon, ClipboardDocumentListIcon, RectangleGroupIcon, XMarkIcon, ChevronDownIcon, ClipboardDocumentCheckIcon } from './icons';
...
const CustomItemComponent: React.FC<{ 
    ...
    isSelected: boolean;
    onToggleSelection: (id: string) => void;
}> = ({ list, item, index, project, onToggle, onOpenDetails, onDragStart, onDragEnd, onDrop, isDragging, isSelectionMode, isSelected, onToggleSelection }) => {
...
const CustomListComponent: React.FC<CustomListComponentProps> = ({ list, projects, onToggleItem, onAddItem, onDeleteList, onOpenDetails, onDragStart, onDragEnd, onDragEnter, onDragOver, onDrop, draggingItem, isDropTarget, activeFilter, onClearFilter, isCollapsed, onToggleCollapse, selection, selectedIds, onStartSelection, onEndSelection, onToggleSelection, onSelectAll, onClearSelection }) => {
  ...
  return (
    <div
        className={`bg-white rounded-xl shadow-md p-6 flex flex-col transition-all duration-200 ${isDropTarget ? 'ring-2 ring-indigo-400 ring-offset-2' : ''}`}
