...
import { ArrowRightOnRectangleIcon, ChevronDownIcon, GoogleIcon, Cog6ToothIcon, ArrowPathIcon } from './icons';
...
const Auth: React.FC<AuthProps> = ({ auth, onOpenSettings, onRefresh }) => {
