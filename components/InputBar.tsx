...
const InputBar: React.FC<InputBarProps> = ({ value, onChange, onSubmit, isLoading, error, isChatting }) => {
  return (
    <div className="w-full max-w-3xl mx-auto px-4">
      <form onSubmit={onSubmit} className="relative w-full">
        <input
          ...
          placeholder="e.g., Buy milk, eggs, and finish the report by Friday..."
        ...
        <div className="absolute right-2.5 top-1/2 -translate-y-1/2 flex items-center gap-2">
            <button
              type="submit"
              disabled={isLoading || isChatting || !value.trim()}
