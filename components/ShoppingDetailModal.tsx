...
const ShoppingDetailModal: React.FC<ShoppingDetailModalProps> = ({ isOpen, onClose, item, projects, onNavigateToProject, onEditItem, onEditDetails, onLinkItem, onUnlinkItem }) => {
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Ajouter une note (ex: prendre la marque bio)..."
                            className="w-full p-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none transition"
                            rows={3}
                        />
                    </div>
