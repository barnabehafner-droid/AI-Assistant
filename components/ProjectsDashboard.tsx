...
const ProjectsDashboard: React.FC<ProjectsDashboardProps> = ({ projects, todos, shoppingList, customLists, onSelectProject, onCreateProject, onPlanProjectWithAI, onDeleteProject, onLinkItems, chatButtonProps }) => {
  return (
            ...
            {projects.map(project => (
             ...
             <div className="bg-white/80 border-2 border-dashed border-slate-300 rounded-xl shadow-sm p-6 flex flex-col items-center justify-center min-h-[200px] transition-all duration-200">
                ...
                <button
                    ...
                    className="w-full h-1/2 flex flex-col items-center justify-center text-slate-500 hover:text-purple-600 hover:bg-purple-50 rounded-b-lg transition-colors duration-200 group"
                >
